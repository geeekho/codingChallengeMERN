...
```bash
git clone --depth 1 https://github.com/geeekho/codingChallengeMERN
cd codingChallengeMERN
```
...
# URL of the Mongo DB
MONGODB_URL=mongodb://127.0.0.1:27017/node-db
...
src\
 ...
 |--guards\         # Routes Authorization control (guard layer)
 |--hooks\          # Custom react hooks
 |--layouts\        # Custom application main layouts
 |--pages\          # Pages components
 |--redux\          # Redux Toolkit configuration
 |--routes\         # Custom routes component and declaration
 |--utils\          # Utility classes and functions
 |--app.js          # Main component
 |--app.js          # Main config file
 |--index.js        # App entry point
```
...
The permissions are role-based. You can view the permissions/rights of each role in the `<path to backend src>/config/roles.js` file.
...
```javascript
const logger = require("<path to backend src>/config/logger");
...
The app also contains 2 custom mongoose plugins that you can attach to any mongoose model schema. You can find the plugins in `<path to backend src>/models/plugins`.
